...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="login-footer" style="margin-top: 32px;">
                <div style="margin-bottom: 16px; padding: 16px; background: rgba(59,130,246,.08); border: 1px solid rgba(59,130,246,.15); border-radius: var(--radius-md);">
                    ...
                    <a href="<?php echo e(route('register')); ?>" style="display: inline-block; background: linear-gradient(135deg, var(--primary), #2563eb); color: #fff; padding: 10px 24px; border-radius: var(--radius-pill); font-weight: 700; font-size: .88rem; text-decoration: none; transition: all .25s; box-shadow: 0 4px 12px rgba(59,130,246,.25);">
                        🚀 Create Your Club
                    </a>
                ...
                <div style="font-size: .72rem; color: #475569;">
                    <?php echo e(\App\ClubOpsEdition::label()); ?> &mdash; Secure Access
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH /Users/homehub/.openclaw/workspace/clubops/resources/views/auth/login.blade.php ENDPATH**/ ?>