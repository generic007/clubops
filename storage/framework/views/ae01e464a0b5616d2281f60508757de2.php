    ...
    <div class="wrapper">
        <div class="card">
            ...
            <div class="footer">
                ...
                <span style="margin-top:6px; display:inline-block; opacity:0.6;"><?php echo e(\App\ClubOpsEdition::label()); ?></span>
            </div>
        </div>
    </div>
</body>
</html>
<?php /**PATH /Users/homehub/.openclaw/workspace/clubops/resources/views/auth/mode-select.blade.php ENDPATH**/ ?>