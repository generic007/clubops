...
<body>
    <div class="card">
        ...
        <a href="<?php echo e(route('register')); ?>" class="btn">🚀 Try Again</a>
        <div class="hint"><a href="<?php echo e(route('landing')); ?>" style="color: var(--primary);">Back to home →</a></div>
    </div>
</body>
</html>
<?php /**PATH /Users/homehub/.openclaw/workspace/clubops/resources/views/errors/419.blade.php ENDPATH**/ ?>