...
<head>
    ...
    <title>Join <?php echo e($invitation->club->name); ?> — ClubOps</title>
    ...
    <div class="wrapper">
        <div class="card">
            ...
            <div class="club-badge">
                <div class="club-name">🏛️ <?php echo e($invitation->club->name); ?></div>
                <div class="club-role">You've been invited as <strong><?php echo e(ucfirst($invitation->role->value)); ?></strong></div>
            ...
            <form method="POST" action="<?php echo e(route('invitations.complete', $invitation->token)); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" value="<?php echo e($invitation->email); ?>" disabled>
                ...
                <button type="submit" class="btn-submit">🚀 Join <?php echo e($invitation->club->name); ?></button>
            </form>

            <div class="text-center mt-3">
                <small class="text-muted">Already have an account? <a href="<?php echo e(route('login')); ?>" style="color: var(--primary);">Sign in</a></small>
            </div>
        </div>
    </div>
</body>
</html>
<?php /**PATH /Users/homehub/.openclaw/workspace/clubops/resources/views/auth/invitation-register.blade.php ENDPATH**/ ?>