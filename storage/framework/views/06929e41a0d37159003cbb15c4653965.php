...
<head>
    ...
    <title><?php if(isset($hideModeSelector) && $hideModeSelector): ?> Create Your Club — ClubOps OS <?php elseif(isset($isMultiTenant) && $isMultiTenant): ?> Create Your Club — ClubOps OS <?php else: ?> Set Up — ClubOps OS <?php endif; ?></title>
...
<body>
    <div class="wrapper">
        <div class="card">
            <div class="brand">
                <div class="icon">♠</div>
                <h1><?php if(isset($hideModeSelector) && $hideModeSelector): ?> Create Your Club <?php elseif(isset($isMultiTenant) && $isMultiTenant): ?> Create Your Club <?php else: ?> Set Up ClubOps <?php endif; ?></h1>
                <p><?php echo e(isset($isMultiTenant) && $isMultiTenant ? 'Name your club and create the owner account.' : 'Create your owner account. A default club will be created for you.'); ?></p>
            </div>
            ...
            <form method="POST" action="<?php echo e(route(isset($hideModeSelector) && $hideModeSelector ? 'register.store' : 'setup.store')); ?>">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="multi_tenant" value="<?php echo e(isset($isMultiTenant) && $isMultiTenant ? '1' : '0'); ?>">

                <?php if(isset($isMultiTenant) && $isMultiTenant): ?>
                <div class="section-divider"><span>🏛️ Your Club</span></div>
                <div class="form-group">
                    <label class="form-label" for="club_name">Club Name</label>
                    <input type="text" name="club_name" id="club_name" class="form-control <?php $__errorArgs = ['club_name'];
...
unset($__errorArgs, $__bag); ?>"
                           value="<?php echo e(old('club_name', 'My Poker Club')); ?>" placeholder="e.g. Ace High Social Club" required autofocus>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="club_description" id="club_description" class="form-control"
                           value="<?php echo e(old('club_description')); ?>" placeholder="e.g. Private poker club in Los Angeles">
                    <?php $__errorArgs = ['club_description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="field-error"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="section-divider"><span>👤 <?php echo e(isset($isMultiTenant) && $isMultiTenant ? 'Club Owner' : 'Your Account'); ?></span></div>
...
unset($__errorArgs, $__bag); ?>"
                           value="<?php echo e(old('name')); ?>" placeholder="e.g. Alex Rivera" required autocomplete="name">
...
unset($__errorArgs, $__bag); ?>"
                           value="<?php echo e(old('email')); ?>" placeholder="you@example.com" required autocomplete="email">
...
unset($__errorArgs, $__bag); ?>
                ...
                <button type="submit" class="btn-submit">🚀 <?php echo e(isset($isMultiTenant) && $isMultiTenant ? 'Create My Club' : 'Get Started'); ?></button>
            </form>

            <div class="footer">
                Already set up? <a href="<?php echo e(route('login')); ?>">Sign in →</a><br>
                <span style="opacity:0.6;"><?php echo e(\App\ClubOpsEdition::label()); ?></span>
            </div>
        </div>
    </div>
</body>
</html>
<?php /**PATH /Users/homehub/.openclaw/workspace/clubops/resources/views/auth/setup.blade.php ENDPATH**/ ?>