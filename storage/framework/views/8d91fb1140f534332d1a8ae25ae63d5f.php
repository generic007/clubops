        ...
        <form method="POST" action="<?php echo e(route('tickets.store')); ?>">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <select name="player_id" class="form-select <?php $__errorArgs = ['player_id'];
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <?php $__currentLoopData = $players; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($p->id); ?>" <?php echo e(old('player_id', request('player_id')) == $p->id ? 'selected' : ''); ?>>
                                <?php echo e($p->name); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mt-4">
                ...
                <a href="<?php echo e(route('tickets.index')); ?>" class="btn btn-outline-secondary">Cancel</a>
            </div>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/homehub/.openclaw/workspace/clubops/resources/views/tickets/create.blade.php ENDPATH**/ ?>