...
<body>
    <div class="card">
        ...
        <p>The invitation to <strong><?php echo e($invitation->club->name); ?></strong> has expired. Invitations are valid for 7 days.</p>
        <a href="<?php echo e(route('login')); ?>" class="btn">Go to Login</a>
    </div>
</body>
</html>
<?php /**PATH /Users/homehub/.openclaw/workspace/clubops/resources/views/auth/invitation-expired.blade.php ENDPATH**/ ?>