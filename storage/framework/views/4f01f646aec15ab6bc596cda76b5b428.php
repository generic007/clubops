...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'ClubOps OS'); ?> — ClubOps</title>
...
<body>
    ...
    <div class="app-layout">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <?php if(\App\ClubOpsEdition::isPro() && !auth()->user()->club?->single_club): ?>
                <a href="<?php echo e(route('invitations.index')); ?>" class="<?php echo e(request()->routeIs('teams*', 'invitations*') ? 'active' : ''); ?>">
                    <span class="nav-icon">👤</span>
                    <span class="nav-text">Team</span>
                </a>
                <?php endif; ?>
                <a href="<?php echo e(route('agents.index')); ?>" class="<?php echo e(request()->routeIs('agents.*') ? 'active' : ''); ?>">
                    <span class="nav-icon">🤝</span>
                ...
                <a href="<?php echo e(route('ledger.entries.index')); ?>" class="<?php echo e(request()->routeIs('ledger.*') ? 'active' : ''); ?>">
                    <span class="nav-icon">💰</span>
                    <span class="nav-text">Ledger</span>
                </a>
                <a href="<?php echo e(route('reconciliations.index')); ?>" class="<?php echo e(request()->routeIs('reconciliations.*') ? 'active' : ''); ?>">
                    <span class="nav-icon">✅</span>
                ...
                <a href="<?php echo e(route('promotions.index')); ?>" class="<?php echo e(request()->routeIs('promotions.*') ? 'active' : ''); ?>">
                    <span class="nav-icon">🎁</span>
                    <span class="nav-text">Promotions</span>
                </a>
                <a href="<?php echo e(route('tickets.index')); ?>" class="<?php echo e(request()->routeIs('tickets.*') ? 'active' : ''); ?>">
                    <span class="nav-icon">🎫</span>
                    <span class="nav-text">Tickets</span>
                </a>
                <a href="<?php echo e(route('imports.index')); ?>" class="<?php echo e(request()->routeIs('imports.*') ? 'active' : ''); ?>">
                    <span class="nav-icon">📥</span>
                ...
                <a href="<?php echo e(route('reports.player-statement', 1)); ?>" class="<?php echo e(request()->routeIs('reports.*') ? 'active' : ''); ?>">
                    <span class="nav-icon">📋</span>
                    <span class="nav-text">Reports</span>
                </a>
                <a href="<?php echo e(route('compliance.index')); ?>" class="<?php echo e(request()->routeIs('compliance.*') ? 'active' : ''); ?>">
                    <span class="nav-icon">🔒</span>
                    <span class="nav-text">Compliance</span>
                </a>
                <a href="<?php echo e(route('audit-log')); ?>" class="<?php echo e(request()->routeIs('audit-log') ? 'active' : ''); ?>">
                    <span class="nav-icon">📜</span>
                    <span class="nav-text">Audit Log</span>
                </a>
                <a href="<?php echo e(route('games.index')); ?>" class="<?php echo e(request()->routeIs('games.*') ? 'active' : ''); ?>">
                    <span class="nav-icon">🎮</span>
            ...
            <div class="sidebar-footer">
                <div class="user-info">
                    ...
                    <div>
                        ...
                        <div class="user-role"><?php echo e(auth()->user()->role->value ?? ''); ?></div>
                    </div>
                </div>
                ...
                <div style="margin-top:8px; display:flex; align-items:center; gap:6px; font-size:.68rem; color:#6ee7b7;">
                    🔒 E2E Encrypted — <?php echo e(\App\ClubOpsEdition::label()); ?>
            ...
            <header class="top-header">
                ...
                <div class="top-header-right">
                    ...
                    <div class="user-dropdown" onclick="event.target.closest('.user-dropdown')?.querySelector('form')?.submit()">
                        ...
                        <span class="dropdown-name d-none d-md-inline"><?php echo e(auth()->user()->name ?? 'User'); ?></span>
                    </div>
                </div>
            </header>
    ...
    <nav class="bottom-nav">
        <div class="bottom-nav-inner">
            ...
            <?php if(\App\ClubOpsEdition::isPro() && !auth()->user()->club?->single_club): ?>
            <a href="<?php echo e(route('invitations.index')); ?>" class="<?php echo e(request()->routeIs('invitations*', 'teams*') ? 'active' : ''); ?>">
                <span class="nav-icon">👤</span>
...
<?php /**PATH /Users/homehub/.openclaw/workspace/clubops/resources/views/layouts/app.blade.php ENDPATH**/ ?>