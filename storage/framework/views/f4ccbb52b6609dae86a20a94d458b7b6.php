<?php $__env->startSection('title', 'New Promotion'); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                        <?php $__currentLoopData = \App\Enums\PromoType::cases(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($t->value); ?>" <?php echo e(old('type') == $t->value ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.01" name="cap" class="form-control" value="<?php echo e(old('cap', 0)); ?>">
                </div>
...
unset($__errorArgs, $__bag); ?>"
                           value="<?php echo e(old('starts_at', date('Y-m-d\T00:00'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-4">
                    ...
                    <input type="datetime-local" name="ends_at" class="form-control" value="<?php echo e(old('ends_at')); ?>">
                </div>

                <div class="col-md-12">
                    <label class="form-label">Terms & Conditions</label>
                    <textarea name="terms" class="form-control" rows="3"><?php echo e(old('terms')); ?></textarea>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/homehub/.openclaw/workspace/clubops/resources/views/promotions/create.blade.php ENDPATH**/ ?>